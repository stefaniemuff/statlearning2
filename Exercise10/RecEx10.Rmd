...
The New York Times stories dataset are contained in the file `pca-exampes.rdata` which is already included in the directory. 
You can still download it from google drive (https://drive.google.com/open?id=1vaK9GDvMw4Hsuv0T1jHeq9ZyrqLhJ6MR) and store in the directory of your Rmd file. 
The `pca-examples.rdata` can be loaded with the following code.
