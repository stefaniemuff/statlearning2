...
* This course had been built up by Mette Langaas at NTNU in 2018 and 2019 and revised by Stefani Muff in 2020-2023. I am using a some of their material, and material from her TAs, throughout the course.  
\vspace{2mm}
**I would like to thank Mette and Steffi for the great work and for the permission to use her material!**
...
* [Sara Martino](https://www.ntnu.no/ansatte/sara.martino); Associate Professor
...
* See here [https://github.com/stefaniemuff/statlearning2/blob/main/TMA4268_schedule2024.pdf](https://github.com/stefaniemuff/statlearning2/blob/main/TMA4268_schedule2024.pdf) for a tentative schedule.
...
[https://github.com/stefaniemuff/statlearning2/blob/main/TMA4268_schedule2024.pdf](https://github.com/stefaniemuff/statlearning2/blob/main/TMA4268_schedule2024.pdf)
...
[https://mattelab2024v.math.ntnu.no/c/tma4268/22](https://mattelab2024v.math.ntnu.no/c/tma4268/22)
...
* Watch the video lecture for Chapter 1 by Hastie and Tibshirani [here](https://wiki.math.ntnu.no/tma4268/2024v/subpage1).
...
library(klaR)
drawparti(iris$Species, iris$Sepal.Length, iris$Sepal.Width,  prec=301, gs=20,  
          method="lda", image.colors=c("#F8766D", "#00BA38", "#619CFF"), xlab="Sepal Length", ylab="Sepal Width", print.err=0)
...
**Q**: What is different in this example?

\pause

  * We do not have a response variable
  * We are not interested in predicting a particular variable but in determining whther there are groups, or clusters, among the observations.
...
order to better understand the disease
  ...
  * Online shopping site: Identify groups of shoppers as well as groups of items
within each of those shoppers groups.

  * Search engine: Search only a subset of the documents in order to find the best
one for retrieval.
