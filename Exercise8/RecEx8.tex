...
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{4268}\NormalTok{)}
\NormalTok{cv.Carseats  }\OtherTok{\textless{}{-}} \FunctionTok{cv.tree}\NormalTok{(...) }
\NormalTok{tree.min }\OtherTok{\textless{}{-}} \FunctionTok{which.min}\NormalTok{(...)}
\NormalTok{best }\OtherTok{\textless{}{-}}\NormalTok{ cv.Carseats}\SpecialCharTok{$}\NormalTok{size[...]}
\end{Highlighting}
\end{Shaded}
