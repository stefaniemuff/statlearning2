...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{yhat }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(tree.mod, }\AttributeTok{newdata =}\NormalTok{ Carseats.test)}
\NormalTok{mse }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((yhat }\SpecialCharTok{{-}}\NormalTok{ Carseats.test}\SpecialCharTok{$}\NormalTok{Sales)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
...
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{4268}\NormalTok{)}
\NormalTok{cv.Carseats }\OtherTok{\textless{}{-}} \FunctionTok{cv.tree}\NormalTok{(tree.mod) }
\NormalTok{tree.min }\OtherTok{\textless{}{-}} \FunctionTok{which.min}\NormalTok{(cv.Carseats}\SpecialCharTok{$}\NormalTok{dev)}
\NormalTok{best }\OtherTok{\textless{}{-}}\NormalTok{ cv.Carseats}\SpecialCharTok{$}\NormalTok{size[tree.min]}
...
\FunctionTok{points}\NormalTok{(cv.Carseats}\SpecialCharTok{$}\NormalTok{size[tree.min],}
\NormalTok{       cv.Carseats}\SpecialCharTok{$}\NormalTok{dev[tree.min],}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{yhat }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(pr.tree, }\AttributeTok{newdata =}\NormalTok{ Carseats.test)}
\NormalTok{mse }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((yhat }\SpecialCharTok{{-}}\NormalTok{ Carseats.test}\SpecialCharTok{$}\NormalTok{Sales)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{) }
\NormalTok{mse}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bag.Carseats }\OtherTok{\textless{}{-}} \FunctionTok{randomForest}\NormalTok{(Sales }\SpecialCharTok{\textasciitilde{}}\NormalTok{ .,}
\NormalTok{                             Carseats.train,}
                             \AttributeTok{mtry =} \FunctionTok{ncol}\NormalTok{(Carseats) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{,}
                             \AttributeTok{ntree =} \DecValTok{500}\NormalTok{,}
                             \AttributeTok{importance =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{yhat.bag }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(bag.Carseats, }\AttributeTok{newdata =}\NormalTok{ Carseats.test)}
\NormalTok{mse.bag }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((yhat.bag }\SpecialCharTok{{-}}\NormalTok{ Carseats.test}\SpecialCharTok{$}\NormalTok{Sales)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{mse.bag}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rf.Carseats }\OtherTok{\textless{}{-}} \FunctionTok{randomForest}\NormalTok{(Sales }\SpecialCharTok{\textasciitilde{}}\NormalTok{ .,}
                            \AttributeTok{data =}\NormalTok{ Carseats.train,}
                            \AttributeTok{mtry =} \DecValTok{3}\NormalTok{,}
                            \AttributeTok{ntree =} \DecValTok{500}\NormalTok{,}
                            \AttributeTok{importance =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{yhat.rf }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(rf.Carseats, }\AttributeTok{newdata =}\NormalTok{ Carseats.test)}
...
\NormalTok{train.predictors }\OtherTok{\textless{}{-}}\NormalTok{ Carseats.train[, }\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\NormalTok{test.predictors }\OtherTok{\textless{}{-}}\NormalTok{ Carseats.test[, }\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\NormalTok{Y.train }\OtherTok{\textless{}{-}}\NormalTok{ Carseats.train[, }\DecValTok{1}\NormalTok{]}
\NormalTok{Y.test }\OtherTok{\textless{}{-}}\NormalTok{ Carseats.test[, }\DecValTok{1}\NormalTok{]}

\NormalTok{ntree }\OtherTok{\textless{}{-}} \DecValTok{500}
\NormalTok{bag.Car }\OtherTok{\textless{}{-}} \FunctionTok{randomForest}\NormalTok{(train.predictors,}
                        \AttributeTok{y =}\NormalTok{ Y.train,}
                        \AttributeTok{xtest =}\NormalTok{ test.predictors,}
                        \AttributeTok{ytest =}\NormalTok{ Y.test,}
                        \AttributeTok{mtry =} \DecValTok{10}\NormalTok{,}
                        \AttributeTok{ntree =}\NormalTok{ ntree)}
\NormalTok{rf.Car }\OtherTok{\textless{}{-}} \FunctionTok{randomForest}\NormalTok{(train.predictors,}
                       \AttributeTok{y =}\NormalTok{ Y.train,}
                       \AttributeTok{xtest =}\NormalTok{ test.predictors,}
                       \AttributeTok{ytest =}\NormalTok{ Y.test,}
                       \AttributeTok{mtry =} \DecValTok{3}\NormalTok{,}
                       \AttributeTok{ntree =}\NormalTok{ ntree)}
\FunctionTok{plot}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{ntree,}
\NormalTok{     bag.Car}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{mse,}
     \AttributeTok{col =} \StringTok{"blue"}\NormalTok{,}
     \AttributeTok{type =} \StringTok{"l"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"Number of Trees"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"Test MSE"}\NormalTok{,}
     \AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\FloatTok{2.8}\NormalTok{))}
\FunctionTok{lines}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{ntree, rf.Car}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{mse, }\AttributeTok{col =} \StringTok{"green"}\NormalTok{)}

\FunctionTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{,}
       \FunctionTok{c}\NormalTok{(}\StringTok{"m = p"}\NormalTok{, }\StringTok{"m = p/3"}\NormalTok{),}
...
\includegraphics[width=0.7\linewidth]{RecEx8-sol_files/figure-latex/unnamed-chunk-13-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{yhat }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(spam.tree,spam[test,],}\AttributeTok{type=}\StringTok{"class"}\NormalTok{)}
\NormalTok{response.test }\OtherTok{\textless{}{-}}\NormalTok{ spam}\SpecialCharTok{$}\NormalTok{type[test]}

\NormalTok{misclass }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(yhat,response.test)}
\NormalTok{misclass}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cv.spam }\OtherTok{\textless{}{-}} \FunctionTok{cv.tree}\NormalTok{(spam.tree, }\AttributeTok{FUN =}\NormalTok{ prune.misclass)}
...
\includegraphics[width=0.9\linewidth]{RecEx8-sol_files/figure-latex/unnamed-chunk-28-1}
