...
Explanation of how n.trees, interaction.depth and shrinkage are chosen. In particular, students should not just use "sufficiently many trees", because n.trees is effectively a tuning parameter in boosting.
