...
\phantomsection\label{learning-material-for-this-module}
\vspace{2mm}
...
\phantomsection\label{what-will-you-learn}
\(~\)
...
\phantomsection\label{introduction-time-line}
\(~\)
...
\phantomsection\label{ai-machine-learning-and-statistics}
...
\phantomsection\label{deep-learning}
\(~\)
...
\phantomsection\label{feedforward-networks}
\centering
...
\phantomsection\label{the-single-hidden-layer-feedforward-network}
\(~\)
...
layer}
\phantomsection\label{special-case-linear-activation-function-for-the-hidden-layer}
\(~\)
...
\phantomsection\label{multilayer-neural-networks}
\(~\)
...
\phantomsection\label{outcome-encoding}
\(~\)
...
\phantomsection\label{example-mnist-dataset}
\(~\)
...
\includegraphics{MNIST_dataset_example.png}
\end{frame}

\begin{frame}
\begin{block}{Neural network parts}
\phantomsection\label{neural-network-parts}
\(~\)
...
\phantomsection\label{output-layer-activation}
\(~\)
...
\phantomsection\label{hidden-layer-activation}
\tiny
...
\phantomsection\label{universal-approximation-property}
\(~\)
...
\phantomsection\label{network-architecture}
\(~\)
...
\phantomsection\label{loss-function-method}
\(~\)
...
\phantomsection\label{optimizors}
\(~\)
...
\phantomsection\label{gradient-descent}
\(~\)
...
\phantomsection\label{finding-optimal-weights-gradient-descent-algorithm}
\vspace{2mm}
...
\phantomsection\label{full-vs.-stochastic-gradient-descent-sgd}
\(~\)
...
\phantomsection\label{mini-batch-stochastic-gradient-descent-sgd}
\(~\)
...
\phantomsection\label{backpropagation-algorithm}
\(~\)
...
\begin{frame}
\begin{block}{Backpropagation algorithm}
\phantomsection\label{backpropagation-algorithm-1}
...
\phantomsection\label{regularization}
\(~\)
...
\phantomsection\label{regularization-in-neural-networks}
\(~\)
...
\phantomsection\label{early-stopping}
...
\begin{frame}
\begin{block}{Dropout}
\phantomsection\label{dropout-1}
...
\phantomsection\label{ways-to-avoid-overfitting}
\(~\)
...
\phantomsection\label{how-to-fit-those-models}
\(~\)
...
\phantomsection\label{boston-house-prices}
\vspace{2mm}
...
\phantomsection\label{boston-example-using-keras}
\(~\)
...
\includegraphics[width=1.2\textwidth,height=\textheight]{fig10_4.png}
\end{column}
...
\phantomsection\label{convolutional-neural-networks-cnns}
\(~\)
...
\phantomsection\label{idea-of-cnns-recognize-features-and-patterns.}
\vspace{2mm}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{fig10_6.png}
\end{frame}

\begin{frame}{Elements of a CNN}
\phantomsection\label{elements-of-a-cnn}
Two types of layers:
...
\phantomsection\label{convolution-layers}
\(~\)
...
\includegraphics[width=0.8\textwidth,height=\textheight]{fig10_7.png}
...
\phantomsection\label{data-augmentation}
\(~\)
...
\includegraphics[width=0.9\textwidth,height=\textheight]{fig10_9.png}
...
Neural Networks}
\phantomsection\label{an-interactive-node-link-visualization-of-convolutional-neural-networks}
\(~\)
...
\phantomsection\label{recurrent-neural-networks-rnns---motivation}
...
\phantomsection\label{problems-with-other-vanilla-nn}
\begin{itemize}
\tightlist
\item
  Length of input
...
\phantomsection\label{recurrent-neural-networks-rnns}
\(~\)
...
\phantomsection\label{fitting-the-weights-in-an-rnn}
\(~\)
...
\phantomsection\label{example-of-an-rnn-time-series-forecasting}
\vspace{2mm}
...
\phantomsection\label{recurrent-neural-network}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{when-to-use-deep-learning}
\(~\)
...
\phantomsection\label{example-the-hitters-data-set}
\(~\)
...
\includegraphics[width=0.6\textwidth,height=\textheight]{bias_variance.png}
\end{frame}

\begin{frame}{Double descent}
\phantomsection\label{double-descent-1}
\includegraphics[width=0.6\textwidth,height=\textheight]{double_descent.png}
...
\begin{frame}
\includegraphics{fig10_21.png}
\end{frame}

\begin{frame}
\includegraphics[width=0.8\textwidth,height=\textheight]{fig10-20-2.png}
\end{frame}

\begin{frame}{Double descent - some consideration}
\phantomsection\label{double-descent---some-consideration}
\begin{itemize}
\item
...
\phantomsection\label{dl-in-medicine}
Lots of papers like those:

\includegraphics[width=0.8\textwidth,height=\textheight]{paper_1.png}

\(~\)
\end{frame}

\begin{frame}{DL/ML in Ecology}
\phantomsection\label{dlml-in-ecology}
\(~\)

\includegraphics{paper2.png}
\end{frame}

\begin{frame}{References and further reading}
\phantomsection\label{references-and-further-reading}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Acknowledgements}
\phantomsection\label{acknowledgements-1}
\phantomsection\label{refs}
\begin{CSLReferences}{1}{0}
\bibitem[\citeproctext]{ref-kerasR}
...
\bibitem[\citeproctext]{ref-goodfellow}
Goodfellow, Ian, Yoshua Bengio, and Aaron Courville. 2016. \emph{Deep
Learning}. MIT Press.

\bibitem[\citeproctext]{ref-ISL}
