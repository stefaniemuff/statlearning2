...
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{../../ISLR/Figures/Chapter4/4.1a.pdf}
\end{block}
\end{frame}
...
\includegraphics{../../ISLR/Figures/Chapter4/4.2.pdf}
\end{block}
\end{frame}
...
\NormalTok{Default}\SpecialCharTok{$}\NormalTok{default }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(Default}\SpecialCharTok{$}\NormalTok{default) }\SpecialCharTok{{-}} \DecValTok{1}
\NormalTok{glm\_default }\OtherTok{=} \FunctionTok{glm}\NormalTok{(default }\SpecialCharTok{\textasciitilde{}}\NormalTok{ balance, }\AttributeTok{data =}\NormalTok{ Default, }\AttributeTok{family =} \StringTok{"binomial"}\NormalTok{)}

\FunctionTok{summary}\NormalTok{(glm\_default)}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{glm\_default2 }\OtherTok{=} \FunctionTok{glm}\NormalTok{(default }\SpecialCharTok{\textasciitilde{}}\NormalTok{ balance }\SpecialCharTok{+}\NormalTok{ income }\SpecialCharTok{+}\NormalTok{ student, }\AttributeTok{data =}\NormalTok{ Default,}
    \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{)}

\FunctionTok{summary}\NormalTok{(glm\_default2)}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{eta }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(glm\_default2)}\SpecialCharTok{$}\NormalTok{coef[, }\DecValTok{1}\NormalTok{] }\SpecialCharTok{\%*\%} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2000}\NormalTok{, }\DecValTok{40000}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\FunctionTok{exp}\NormalTok{(eta)}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{+} \FunctionTok{exp}\NormalTok{(eta))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{d.heart }\OtherTok{\textless{}{-}}\NormalTok{ SAheart}
\NormalTok{d.heart}\SpecialCharTok{$}\NormalTok{chd }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(d.heart}\SpecialCharTok{$}\NormalTok{chd)}
\NormalTok{d.heart }\OtherTok{\textless{}{-}}\NormalTok{ d.heart[, }\FunctionTok{c}\NormalTok{(}\StringTok{"sbp"}\NormalTok{, }\StringTok{"tobacco"}\NormalTok{, }\StringTok{"ldl"}\NormalTok{, }\StringTok{"famhist"}\NormalTok{, }\StringTok{"obesity"}\NormalTok{,}
    \StringTok{"alcohol"}\NormalTok{, }\StringTok{"age"}\NormalTok{, }\StringTok{"chd"}\NormalTok{)]}
\FunctionTok{head}\NormalTok{(d.heart)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.8\linewidth]{4Classif_files/figure-beamer/ggpairs_heart-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.5\linewidth]{4Classif_files/figure-beamer/knn-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{4Classif_files/figure-beamer/unnamed-chunk-9-1} \end{center}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{../../ISLR/Figures/Chapter4/4.5.pdf}
\end{frame}
...
\begin{center}\includegraphics[width=0.55\linewidth]{4Classif_files/figure-beamer/synthAB2-1} \end{center}
\end{block}
\end{frame}
...
\begin{center}\includegraphics[width=0.55\linewidth]{4Classif_files/figure-beamer/unnamed-chunk-12-1} \end{center}
\end{block}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{r.pred }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{X2 }\SpecialCharTok{\textless{}} \DecValTok{4} \SpecialCharTok{{-}}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{X1, }\StringTok{"A"}\NormalTok{, }\StringTok{"B"}\NormalTok{)}
\NormalTok{tab }\OtherTok{=} \FunctionTok{table}\NormalTok{(}\AttributeTok{real =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{class, r.pred)}
\NormalTok{tab}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{r.lda }\OtherTok{\textless{}{-}} \FunctionTok{lda}\NormalTok{(class }\SpecialCharTok{\textasciitilde{}}\NormalTok{ X1 }\SpecialCharTok{+}\NormalTok{ X2, df)}
\NormalTok{r.pred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(r.lda, df)}\SpecialCharTok{$}\NormalTok{class}
\NormalTok{tab }\OtherTok{=} \FunctionTok{table}\NormalTok{(}\AttributeTok{real =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{class, }\AttributeTok{predicted =}\NormalTok{ r.pred)}
\NormalTok{tab}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\textwidth,height=\textheight]{../../ISLR/Figures/Chapter4/4.9.pdf}
\end{block}
\end{frame}
...
\begin{frame}
\begin{center}\includegraphics[width=0.8\linewidth]{4Classif_files/figure-beamer/iris1-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth]{4Classif_files/figure-beamer/iris2-1} \end{center}
\end{block}
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth]{4Classif_files/figure-beamer/iris3-1} \end{center}
\end{block}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(}\FunctionTok{predict}\NormalTok{(iris\_lda2, }\AttributeTok{newdata =}\NormalTok{ iris\_train)}\SpecialCharTok{$}\NormalTok{class, iris\_train}\SpecialCharTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris\_lda2\_predict }\OtherTok{=} \FunctionTok{predict}\NormalTok{(iris\_lda2, }\AttributeTok{newdata =}\NormalTok{ iris\_test)}
\FunctionTok{table}\NormalTok{(iris\_lda2\_predict}\SpecialCharTok{$}\NormalTok{class, iris}\SpecialCharTok{$}\NormalTok{Species[}\SpecialCharTok{{-}}\NormalTok{train])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(}\FunctionTok{predict}\NormalTok{(iris\_qda2, }\AttributeTok{newdata =}\NormalTok{ iris\_train)}\SpecialCharTok{$}\NormalTok{class, iris\_train}\SpecialCharTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris\_qda2\_predict }\OtherTok{=} \FunctionTok{predict}\NormalTok{(iris\_qda2, }\AttributeTok{newdata =}\NormalTok{ iris\_test)}
\FunctionTok{table}\NormalTok{(iris\_qda2\_predict}\SpecialCharTok{$}\NormalTok{class, iris}\SpecialCharTok{$}\NormalTok{Species[}\SpecialCharTok{{-}}\NormalTok{train])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{glm\_SA }\OtherTok{=} \FunctionTok{glm}\NormalTok{(chd }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ train\_SA, }\AttributeTok{family =} \StringTok{"binomial"}\NormalTok{)}
\FunctionTok{summary}\NormalTok{(glm\_SA)}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
Pred. Status
\end{minipage}} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.3333} + 4\tabcolsep}@{}}{%
...
\begin{center}\includegraphics[width=0.7\linewidth]{4Classif_files/figure-beamer/roc-1} \end{center}
\end{block}
\end{frame}
