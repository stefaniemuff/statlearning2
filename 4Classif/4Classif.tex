...
\begin{center}\includegraphics[width=0.9\linewidth]{4Classif_files/figure-beamer/unnamed-chunk-8-1} \end{center}
...
\FunctionTok{table}\NormalTok{(}\AttributeTok{real =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{class, r.pred)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{table}\NormalTok{(}\AttributeTok{real =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{class, }\AttributeTok{predicted =}\NormalTok{ r.pred)}
\end{Highlighting}
\end{Shaded}
