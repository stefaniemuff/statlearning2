...
p1 = ggplot() +geom_point(data = data0, aes(x0,y0), size=0.7) + geom_line(data = data, aes(x=x, y=predict(lm(y~x))), col="red")+ggtitle("poly1")+theme_minimal()
p2 = ggplot() +geom_point(data = data0, aes(x0,y0),size=0.7) + geom_line(data = data, aes(x=x, y=predict(lm(y~poly(x,2)))), col="orange")+ggtitle("poly2")+theme_minimal()
p3 =  ggplot() +geom_point(data = data0, aes(x0,y0),size=0.7) + geom_line(data = data, aes(x=x, y=predict(lm(y~poly(x, 10)))), col="pink")+ggtitle("poly10")+theme_minimal()
p4 =  ggplot() +geom_point(data = data0, aes(x0,y0),size=0.7) + geom_line(data = data, aes(x=x, y=predict(lm(y~poly(x, 20)))), col="purple")+ggtitle("poly20")+theme_minimal()
