...
The request is a design matrix for a natural spline with $X =$ `year` and one knot $c_1 = 2006$. The boundary knots should be the extreme values of `year`, that is $c_0 = 2003$ and $c_2 = 2009$. A general basis for a natural spline is
