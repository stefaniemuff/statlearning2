...
\begin{center}\includegraphics[width=0.7\linewidth]{3LinReg_files/figure-beamer/motivating2b-1} \end{center}
\end{frame}
...
Note: The true regression line goes through \(\mathsf{E}(Y|X= x)\).
\end{block}
\end{frame}
...
\href{https://github.com/stefaniemuff/statlearning2/blob/master/literature/Walepole_book.pdf}{here}.
\end{block}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(r.bodyfat)}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{niter }\OtherTok{\textless{}{-}} \DecValTok{1000}
\NormalTok{pars }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\AttributeTok{nrow =}\NormalTok{ niter, }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (ii }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{niter) \{}
\NormalTok{    x }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{)}
\NormalTok{    y }\OtherTok{\textless{}{-}} \DecValTok{4} \SpecialCharTok{{-}} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ x }\SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\DecValTok{0}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.5}\NormalTok{)}
\NormalTok{    pars[ii, ] }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x)}\SpecialCharTok{$}\NormalTok{coef}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\item
  What are the characteristcs of \(\hat\sigma^2\)?
...
\begin{frame}
\begin{block}{Estimated Variance for \(\beta_1\)}
\protect\hypertarget{estimated-variance-for-beta_1}{}
\begin{itemize}
\tightlist
\item
  So actually we have
...
\tightlist
\item
  \textbf{``Which values of the parameters are compatible with the
  data?''}
\end{enumerate}
...
a known distribution under \(H_0\).

For our purpose, we use the so-called \textbf{\(T\)-statistic}
...
\protect\hypertarget{recap-the-t-distribution}{}
\(~\)
...
\protect\hypertarget{recap-formal-definition-of-the-p-value}{}
\(~\)
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coefs }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(r.bodyfat)}\SpecialCharTok{$}\NormalTok{coef}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(r.bodyfat)}\SpecialCharTok{$}\NormalTok{r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(d.bodyfat}\SpecialCharTok{$}\NormalTok{bodyfat, d.bodyfat}\SpecialCharTok{$}\NormalTok{bmi)}\SpecialCharTok{\^{}}\DecValTok{2}
\end{Highlighting}
\end{Shaded}
...
With least squares, we minimize the RSS for a multiple linear regression
model:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X }\OtherTok{=} \FunctionTok{model.matrix}\NormalTok{(r.bodyfat3)}
\NormalTok{Y }\OtherTok{=}\NormalTok{ d.bodyfat}\SpecialCharTok{$}\NormalTok{bodyfat}
...
\begin{frame}
\begin{block}{Where were we?}
\protect\hypertarget{where-were-we}{}
\vspace{2cm}
...
\item
  ...
  \(\epsilon\sim N_n(0,\sigma^2\boldsymbol{I})\)
\item
  \textbf{Parameter estimate:}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(r.bodyfatM1)}\SpecialCharTok{$}\NormalTok{r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(r.bodyfatM2)}\SpecialCharTok{$}\NormalTok{r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(r.bodyfatM3)}\SpecialCharTok{$}\NormalTok{r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}
\begin{center}\includegraphics[width=0.5\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-23-1} \end{center}
...
\begin{frame}
\begin{block}{Qualitative predictors with more than 2 ( \(k\) ) levels}
\protect\hypertarget{qualitative-predictors-with-more-than-2-k-levels}{}
\(~\)
...
\includegraphics[width=0.75\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-27-1}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{r.lm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Balance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Ethnicity, }\AttributeTok{data =}\NormalTok{ Credit)}
\FunctionTok{summary}\NormalTok{(r.lm)}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Credit }\OtherTok{\textless{}{-}} \FunctionTok{mutate}\NormalTok{(Credit, }\AttributeTok{Ethnicity =} \FunctionTok{relevel}\NormalTok{(Ethnicity, }\AttributeTok{ref =} \StringTok{"Caucasian"}\NormalTok{))}
\NormalTok{r.lm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Balance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Ethnicity, }\AttributeTok{data =}\NormalTok{ Credit)}
\FunctionTok{summary}\NormalTok{(r.lm)}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{../../ISLR/Figures/Chapter3/3.7.pdf}
...
\(\rightarrow\) See problem 1 in recommended exercises for module 3
(important)!
...
\begin{center}\includegraphics[width=0.4\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-34-1} \end{center}
...
\begin{center}\includegraphics[width=0.45\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-35-1} \end{center}
\end{block}
\end{frame}
...
\begin{center}\includegraphics[width=0.8\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-36-1} \end{center}
...
\begin{center}\includegraphics[width=0.45\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-37-1} \end{center}
