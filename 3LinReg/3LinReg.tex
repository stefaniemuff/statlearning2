...
\includegraphics[width=0.75\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-26-1}
\end{frame}
...
\begin{center}\includegraphics[width=0.4\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-33-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-35-1} \end{center}
...
\begin{center}\includegraphics[width=0.45\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-36-1} \end{center}
