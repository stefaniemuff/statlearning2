...
roc_logReg <- roc(response=titanic_test$Survived, predictor=predict(logReg, titanic_test, type="response"), direction="<")
roc_lda <- roc(response=titanic_test$Survived, predictor=predict(lda_model, titanic_test)$posterior[,2], direction="<")
roc_qda <- roc(response=titanic_test$Survived, predictor=predict(qda_model, titanic_test)$posterior[,2], direction="<")
