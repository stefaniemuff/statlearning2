...
the direction of steepest ascent is given by an $N$-dimensional _\textcolor{red}{gradient vector}_ $\mathbf{g}^\top = (g_{1},g_{2},\ldots, g_{N})$ with entries
...
Recall that we want to fit trees $$f_m(x)=T(x;\Theta_m)=\sum_{j=1}^J \gamma_j I(x\in R_j) \ , $$ not aribtrary predictor functions $\mathbf{f}_m$. 
