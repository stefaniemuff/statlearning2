...
$$\overline{f}(X_j) = \frac1N \sum_{i=1}^N f(X_{ji},(X_{-j})_i)$$
for a set of values for $X_j$, where we evaluate the estimated tree value $f(X_{ji},(X_{-j})_i)$ for each data point $i$. 
