...
\hypersetup{
  ...
  pdfauthor={Stefanie Muff and Sara Martino, Department of Mathematical Sciences, NTNU},
  colorlinks=true,
  linkcolor={Maroon},
  filecolor={Maroon},
  citecolor={Blue},
...
\phantomsection\label{boosting-methods}
\(~\)
...
\phantomsection\label{boosted-trees-vs-deep-learning-neural-networks}
\(~\)
...
\phantomsection\label{examples-recent-literature}
\centering
...
\phantomsection\label{recap-trees-and-random-forests}
\(~\)
...
\phantomsection\label{motivation-for-boosting-in-the-context-of-trees}
\(~\)
...
AdaBoost}
\phantomsection\label{simple-example-1-boosting-for-a-classification-problem-adaboost}
\tiny
...
\phantomsection\label{error-rates-adaboost-vs-random-forest}
\(~\)
...
\phantomsection\label{simple-example-2-boosting-regression-trees}
\(~\)
...
\phantomsection\label{revisit-the-boston-data-from-module-8}
\(~\)
...
\phantomsection\label{boosting-more-generally}
\(~\)
...
\phantomsection\label{boosting-trees-what-do-we-want-to-minimize}
\(~\)
...
\phantomsection\label{from-single-trees-to-boosting}
\label{sl:toBoosting}
...
\phantomsection\label{steepest-descent-a-numerical-optimization-technique}
\(~\)
...
\phantomsection\label{gradient-boosting-steepest-descent-for-trees}
\(~\)
...
\phantomsection\label{gradient-tree-boosting-algorithm}
\(~\)
...
\phantomsection\label{gradient-tree-boosting-for-regression}
\(~\)
...
\phantomsection\label{gradient-tree-boosting-for-regression-loss-functions}
\(~\)
...
\phantomsection\label{gradient-tree-boosting-for-binary-classification}
\(~\)
...
classes}
\phantomsection\label{gradient-tree-boosting-for-classification-into-k-classes}
\(~\)
...
\phantomsection\label{practical-considerations}
...
\phantomsection\label{parameter-tuning}
\(~\)
...
\phantomsection\label{a-finding-the-right-tree-depth-in-boosting}
...
\phantomsection\label{b-minimum-number-of-observations-in-terminal-nodes}
\(~\)
...
\phantomsection\label{c-the-number-of-trees-regularization-strategy-1}
\(~\)
...
\phantomsection\label{d-the-learning-rate-regularization-strategy-2}
\(~\)
...
\phantomsection\label{application-ames-housing-data}
\scriptsize
...
\phantomsection\label{stochastic-gbms-regularization-strategy-3}
\scriptsize
...
\phantomsection\label{variants-of-stochastic-gbms}
\(~\)
...
\phantomsection\label{xgboost-extreme-gradient-boosting}
...
\phantomsection\label{some-words-on-regularization-in-xgboost}
\(~\)
...
\phantomsection\label{ames-house-pricing-example-continued}
\vspace{2mm}
...
\phantomsection\label{hyperparameter-tuning}
\(~\)
...
\phantomsection\label{most-recent-advances-lightbgm-catboost}
\vspace{2mm}
...
\phantomsection\label{interpretation-of-tree-ensembles}
\(~\)
...
\phantomsection\label{partial-dependence-plots}
\scriptsize
...
\phantomsection\label{partial-dependence-plots-for-the-boston-example}
\(~\)
...
\bibitem[\citeproctext]{ref-boehmke_greenwell2020}
