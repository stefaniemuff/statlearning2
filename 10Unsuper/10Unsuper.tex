...
\phantomsection\label{pca---standardization}
\begin{itemize}
\tightlist
\item
  Mentimeter
...
\phantomsection\label{pca---standardization-1}
\begin{verbatim}
...
\phantomsection\label{explained-variance}
\includegraphics{10Unsuper_files/figure-beamer/unnamed-chunk-5-1.pdf}
\end{frame}

\begin{frame}{Biplot}
\phantomsection\label{biplot}
\includegraphics{10Unsuper_files/figure-beamer/unnamed-chunk-6-1.pdf}
\end{frame}

\begin{frame}[fragile]
\begin{block}{PCA example}
\phantomsection\label{pca-example}
\(~\)
...
\phantomsection\label{proportion-of-varianced-explained-pve}
\(~\)
...
\phantomsection\label{scree-plot}
\(~\)
...
\includegraphics[width=0.9\linewidth]{10Unsuper_files/figure-beamer/unnamed-chunk-9-1}
\end{block}
\end{frame}
...
\includegraphics{10Unsuper_files/figure-beamer/unnamed-chunk-11-1.pdf}
\end{frame}

\begin{frame}{PCA}
\phantomsection\label{pca}
\includegraphics{10Unsuper_files/figure-beamer/unnamed-chunk-12-1.pdf}
\end{frame}

\begin{frame}[fragile]{Variance Explained}
\phantomsection\label{variance-explained}
\footnotesize
...
\phantomsection\label{variance-explained---scree-plot}
\includegraphics{10Unsuper_files/figure-beamer/unnamed-chunk-14-1.pdf}
\end{frame}

\begin{frame}{Clustering}
\phantomsection\label{clustering}
\(~\)
...
\phantomsection\label{k-means-vs.-hierarchical-clustering}
\(~\)
...
\phantomsection\label{k-means-clustering}
\(~\)
...
\phantomsection\label{k-means-clustering---algorithm}
\includegraphics{imgs/kmeans_algo.png}
\end{frame}

\begin{frame}
\begin{block}{Hierarchical clustering}
\phantomsection\label{hierarchical-clustering}
\(~\)
...
\phantomsection\label{important-in-hierarchical-clustering}
\(~\)
...
\phantomsection\label{hierarchical-clustering-example}
\(~\)
...
\phantomsection\label{nested-clusters}
...
\phantomsection\label{standardization}
...
\phantomsection\label{exercise-2-from-the-book}
...
\phantomsection\label{exercise-11-from-the-book}
...
issues}
\phantomsection\label{pros-and-cons-of-clusterization-methods-practical-issues}
\(~\)
