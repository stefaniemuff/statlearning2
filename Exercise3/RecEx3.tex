...
\CommentTok{\# Count how many times the true value is within the confidence}
\CommentTok{\# interval}
...
\NormalTok{    y }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\AttributeTok{n =}\NormalTok{ nobs, }\AttributeTok{mean =}\NormalTok{ Xmat }\SpecialCharTok{\%*\%}\NormalTok{ true\_beta, }\AttributeTok{sd =} \FunctionTok{rep}\NormalTok{(true\_sd,}
\NormalTok{        nobs))}
